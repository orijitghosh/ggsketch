...
`geom_sketch_histogram()` bins a continuous variable and draws
hand-drawn bars (the sketch analogue of
...
- binwidth:
  ...
  Bin width; overrides `bins` when supplied.
...
- fill_style:
  ...
  `"scribble"`, `"dots"`, `"dashed"`, `"stipple"`, `"pencil_shade"`, or
