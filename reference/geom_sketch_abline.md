...
An object of class `GeomSketchAbline` (inherits from `Geom`, `ggproto`,
`gg`) of length 6.

An object of class `GeomSketchHline` (inherits from `Geom`, `ggproto`,
`gg`) of length 6.

An object of class `GeomSketchVline` (inherits from `Geom`, `ggproto`,
`gg`) of length 6.
