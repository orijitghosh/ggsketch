...
- medium:
  ...
  The default `"pen"` is the classic constant-width double stroke; the
  others (`"ink"`, `"brush"`, `"pencil"`, `"chalk"`, `"marker"`,
  `"highlighter"`, `"crayon"`) render through the variable-width
