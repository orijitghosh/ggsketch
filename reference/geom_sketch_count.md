...
draws a sketch point at each `(x, y)` location sized by the number of
observations there, via
[`ggplot2::stat_sum()`](https://ggplot2.tidyverse.org/reference/geom_count.html).
Pair with
[`ggplot2::scale_size_area()`](https://ggplot2.tidyverse.org/reference/scale_size.html)
for honest area scaling.
