...
- arrow_head:
  ...
  `"triangle_open"`, `"triangle_filled"`, `"barb"` (swept harpoon
  barbs), `"fishtail"` (forked swallowtail), `"dot"` (a blob) or `"bar"`
  (a perpendicular tick). `NULL` (default) derives it from `arrow_type`.
