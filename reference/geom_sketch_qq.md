...
`geom_sketch_qq_line()` adds the reference line
([`ggplot2::geom_qq_line()`](https://ggplot2.tidyverse.org/reference/geom_qq.html)).
Map the data to the `sample` aesthetic.
...
- distribution:
  ...
  Quantile function for the theoretical distribution. Default
